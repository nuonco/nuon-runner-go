...
type ClientService interface {
	...
	GetInstallOwnerPlan(params *GetInstallOwnerPlanParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetInstallOwnerPlanCreated, error)
...
/*
GetInstallOwnerPlan get install owner plan API
*/
func (a *Client) GetInstallOwnerPlan(params *GetInstallOwnerPlanParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetInstallOwnerPlanCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetInstallOwnerPlanParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetInstallOwnerPlan",
		Method:             "GET",
		PathPattern:        "/v1/install/{install_id}/owner-plans/{owner_id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetInstallOwnerPlanReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetInstallOwnerPlanCreated)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetInstallOwnerPlan: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
