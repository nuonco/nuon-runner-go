...
func (o *GetAppConfigSyncRunOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/apps/{app_id}/config-sync-run/{app_config_sync_run_id}][%d] getAppConfigSyncRunOK %s", 200, payload)
}
...
func (o *GetAppConfigSyncRunBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/config-sync-run/{app_config_sync_run_id}][%d] getAppConfigSyncRunBadRequest %s", 400, payload)
}
...
func (o *GetAppConfigSyncRunUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/config-sync-run/{app_config_sync_run_id}][%d] getAppConfigSyncRunUnauthorized %s", 401, payload)
}
...
func (o *GetAppConfigSyncRunForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/config-sync-run/{app_config_sync_run_id}][%d] getAppConfigSyncRunForbidden %s", 403, payload)
}
...
func (o *GetAppConfigSyncRunNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/config-sync-run/{app_config_sync_run_id}][%d] getAppConfigSyncRunNotFound %s", 404, payload)
}
...
func (o *GetAppConfigSyncRunInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/config-sync-run/{app_config_sync_run_id}][%d] getAppConfigSyncRunInternalServerError %s", 500, payload)
}
