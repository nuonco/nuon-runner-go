...
func (m *ChartMetadata) validateDependencies(formats strfmt.Registry) error {
...
func (m *ChartMetadata) validateMaintainers(formats strfmt.Registry) error {
...
// ContextValidate validate this chart metadata based on the context it is used
...
func (m *ChartMetadata) contextValidateDependencies(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ChartMetadata) contextValidateMaintainers(ctx context.Context, formats strfmt.Registry) error {
